...
async def ajuda(ctx):
    ...
    em.add_field(name = "Propriedades", value = "- diga um olá para mim! Basta digitar olá e me mencionar.\
        \n- anime: Sorteie qualquer coisa sendo da sua escolha e o resultado será mostrado com um GIF! :laughing: (A divisão do que será sorteado é através do uso da vírgula).\
